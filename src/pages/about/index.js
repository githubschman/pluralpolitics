...
const WhoMadeTheTest = (
  <div>
    <Paragraph className={styles.paragraph}>
      I’m Nate Coffman. I’m an American, aged 26, from Pennsylvania, living in
      Washington, D.C. where I work for the U.S. government. This test is a
      personal project.
    </Paragraph>
    <Paragraph className={styles.paragraph}>
      I’m involved with a few projects re improving the quality of politics and
      governance in the U.S. and elsewhere, including{' '}
      <a
        target="_blank"
        rel="noreferrer"
        href="https://www.thereconstitution.com/"
      >
        The Reconstitution
      </a>{' '}
      &{' '}
      <a
        target="_blank"
        rel="noreferrer"
        href="https://www.youtube.com/channel/UCIuhGOD1cknRPV3HymQQhpA"
      >
  ...
  <div>
    <Paragraph className={styles.paragraph}>
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="https://firebasestorage.googleapis.com/v0/b/plural-politics.appspot.com/o/Whitepaper%20-%20Plural%20Politics.pdf?alt=media&token=23406b66-17b4-4d06-9a58-2e8c388a3949"
      >
        whitepaper
      </a>{' '}
      for some empiricism.
...
const DoYouCollectAnyInfo = (
  <div>
    <Paragraph className={styles.paragraph}>
      ...
      what everyone is scoring. Your final score is all I’m collecting, though.
      No individual answers or anything else about you & yours.
    </Paragraph>
  </div>
)
...
const TestChanges = (
  <div>
    <Paragraph className={styles.paragraph}>
      ...
      the site. Also, I think I’ll eventually add a fifth & maybe a sixth
      metric.
    </Paragraph>
  </div>
)
...
const ArtWork = (
  <div>
    <Paragraph className={styles.paragraph}>
      The artwork on the front page was made by Emmanuel Lafont, a wonderful
      artist who graciously let me use his work for free. Check out his work on{' '}
      <a target="_blank" rel="noreferrer" href="http://www.emmanuellafont.com/">
        his website
      </a>{' '}
      &{' '}
      <a
        target="_blank"
        rel="noreferrer"
        href="https://www.instagram.com/emmanuellafont/?hl=en"
      >
        Instagram
      </a>
      . The Plural Politics logo was made by my brother, Nick Coffman, a
      brilliant graphic designer & brand marketing specialist. Here’s his{' '}
      <a
        target="_blank"
        rel="noreferrer"
...
const Website = (
  <div>
    <Paragraph style={{ paddingBottom: '100px' }} className={styles.paragraph}>
