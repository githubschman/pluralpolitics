...
const HowIsThisDifferent = <div>
  <Paragraph className={styles.paragraph}>I’ll refer you to the <a target="_blank" rel="noreferrer" href="https://firebasestorage.googleapis.com/v0/b/plural-politics.appspot.com/o/Whitepaper%20-%20Plural%20Politics.pdf?alt=media&token=23406b66-17b4-4d06-9a58-2e8c388a3949">whitepaper</a> for the story there. I go into some depth about the why of this project & how exactly it differs from the Political Compass. Note: the test is really quite different from and isn’t an adoption or adaptation of the Political Compass. (Please don’t sue me, copyright lawyers.)</Paragraph>
</div>

const DoYouCollectAnyInfo = <div>
  <Paragraph className={styles.paragraph}>Yeah, a little bit. To give accurate secondary information I have to know what everyone is scoring. But besides your answers, results & general location, I’m not collecting anything else about you & yours.</Paragraph>
</div>
