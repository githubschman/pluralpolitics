...
const EditTest = () => {
  ...
  const updateAnswerText = (e) => {
    ...
    if (!subfield) {
      ...
      updatedTestData[questionIndex].answers[answerIndex][field][subfield] =
        value
    }
  ...
  return (
    <div>
      ...
      >
        ...
        {testData &&
          ...
          testData.map((question, i) => (
            <Form.Item key={`editing-question-${i}`}>
              ...
              <Form.Item shouldUpdate label="Question Category Tag">
                <Input
              ...
              <Form.Item shouldUpdate label="Question Bucket">
                <Input
                  name={`question-bucket-${i}`}
                  data-field="bucket"
                  data-question-index={i}
                  required
                  defaultValue={question.bucket || ''}
                  onChange={debounceUpdateQuestionData}
                />
              </Form.Item>
              <Form.Item>
        ...
        <Form.Item>
          <Button onClick={updateTestInDb} type="primary">
            Submit
          </Button>
        </Form.Item>
      </Form>
